...
export { Button, ButtonProps, IconButton } from './components/Button';
...
export { ChipDataTest, ChipProps, default as Chip } from './components/Chip';
export { CodeInputType, default as CodeInput } from './components/CodeInput';
export {
  AbsolutelyCentered,
  CustomCircularProgressProps,
  default as CustomCircularProgress,
  RelativelyCentered
} from './components/CustomCircularProgress';
...
export { default as Icons, Icon, isValidIcon } from './components/Icons';
